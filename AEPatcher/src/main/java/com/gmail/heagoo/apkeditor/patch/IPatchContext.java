...
public interface IPatchContext {
	...
	public void info(int resourceId, boolean bBold, boolean red, boolean green, Object... args);
	
	public void info(int resourceId, boolean bBold, boolean red, Object... args);
